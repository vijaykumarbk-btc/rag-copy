...
export class LiteParse {
     ...
     * @returns {Promise<ParseSession>}
     */
    openBatchSession(data, batch_size) {
        const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc_command_export);
        const len0 = WASM_VECTOR_LEN;
        let ret;
        __wbg_call_guard();
        try {
            ret = wasm.liteparse_openBatchSession(this.__wbg_ptr, ptr0, len0, isLikeNone(batch_size) ? Number.MAX_SAFE_INTEGER : (batch_size) >>> 0);
        } catch(e) {
            __wbg_handle_catch(e);
        }
        return ret;
...
export class ParseSession {
    static __wrap(ptr) {
        const obj = Object.create(ParseSession.prototype);
        obj.__wbg_ptr = ptr;
        ParseSessionFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        ParseSessionFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        __wbg_call_guard();
        try {
            wasm.__wbg_parsesession_free(ptr, 0);
        } catch(e) {
            __wbg_handle_catch(e);
        }
     ...
     * @returns {Promise<ParseBatch | undefined>}
     */
    nextBatch() {
        let ret;
        __wbg_call_guard();
        try {
            ret = wasm.parsesession_nextBatch(this.__wbg_ptr);
        } catch(e) {
            __wbg_handle_catch(e);
        }
        return ret;
    ...
    get totalPages() {
        ...
        __wbg_call_guard();
        try {
            ret = wasm.parsesession_totalPages(this.__wbg_ptr);
        } catch(e) {
            __wbg_handle_catch(e);
        }
        return ret >>> 0;
...
if (Symbol.dispose) ParseSession.prototype[Symbol.dispose] = ParseSession.prototype.free;
...
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbg_parsesession_new: function() { return wrapError(function (arg0) {
            const ret = ParseSession.__wrap(arg0);
            return ret;
        }, arguments); },
        ...
        __wbindgen_cast_0000000000000001: function() { return wrapError(function (arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [Externref], shim_idx: 3198, ret: Result(Unit), inner_ret: Some(Result(Unit)) }, mutable: true }) -> Externref`.
...
const ParseSessionFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_parsesession_free(ptr, 1));
